  ...
  \cventry
    ...
    {Mar. 2023 - Present} % Date(s)
    {
      ...
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item {Investigated the \underline{nonlinear Duffing oscillator dynamics} of single $^{174}$Yb⁺ ion}
  ...
  \cventry
    ...
    {Aug. 2021 - Dec. 2022} % Date(s)
    {
      ...
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item {Converted TCAD model to \underline{Spice model by BSIM4 library}}
        \item {Integrated HEMT model with clamp circuit in LTspice to achieve normally-off operation and optimized switching speed}
        \item {Achieved \underline{high power conversion efficiency} in a DC-DC boost converter}
      \end{cvitems}
    }
%---------------------------------------------------------
\end{cventries}
