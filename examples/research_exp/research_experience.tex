...
\begin{figure}[!h]
    ...
    \begin{minipage}{6in}
        ...
        \caption{
        (\textbf{a}) Cross-sectional view of the designed multi-layer ion trap and simulated radial potential distribution (Ansys Maxwell 3D).
...
\begin{itemize}[leftmargin=3.0em, itemsep=0.0em, topsep=0.0em]
    \item Designed a multi-layer ion trap chip composed of nine stacked layers, including DC/RF layers for providing trapping potential, shim layers to compensate the principal axes and micromotion, and spacer layers. A shield layer is positioned on the top of the chip to collimate the ablated atomic beam. The DC electrodes are segmented to enable ion shuttling, as depicted in Fig.~\ref{fig:figure1}(a, left).
    \item Simulated the designed structure with $\Omega_{\mathrm{RF}} = 2\pi\cdot 20.26~\mathrm{MHz}$ and $V_{\mathrm{RF}} = 75~\mathrm{V}$ using Ansys Maxwell 3D electrostatic simulations, as shown in Fig.~\ref{fig:figure1}(a, right). The results yield radial secular frequencies of about $3~\mathrm{MHz}$, in good agreement with the experimentally measured values.
...
\begin{itemize}[leftmargin=3.0em, itemsep=0.0em, topsep=0.0em]
    ...
    \item Demonstrated trapping of up to two ions and performed micromotion compensation by narrowing the Lorentzian linewidth in 397~nm spectroscopy, as shown in Fig.~\ref{fig:figure2}(c).
    
    \item Presented this cryogenic ion-trap setup and preliminary results at the 2024 Korean Conference on Semiconductors and received an on-site outstanding poster award.
\end{itemize}
...
\begin{itemize}[leftmargin=3.0em, itemsep=0.2em, topsep=0.2em, parsep=0pt]
    ...
    \item Presented the results at the 2022 Conference on Semiconductor Engineering and at the 2023 Korean Conference on Semiconductors, where I received an undergraduate poster presentation award.
\end{itemize}
